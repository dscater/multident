...
<body>
    ...
    <div class="contenedor_factura ml-auto mr-auto" id="contenedor_imprimir">
        ...
        <div class="elemento detalle izquierda">
            ...
            <br />
            Cliente:
            {{ $proforma->cliente ? $proforma->cliente->full_name : '' }}
            <br />
            NIT/C.I.: {{ $proforma->nit_ci }}
            <br />
            Caja:
            {{ $proforma->user ? $proforma->user->usuario : '' }}
            <br />
            Valido hasta:
            {{ $proforma->fecha_validez_t }}
            <br />
        </div>
        ...
        <div class="cobro">
            <table>
                ...
                @foreach ($proforma->detalle_proformas as $item)
                    <tr>
                        <td class="centreado">
                            {{ $item->cantidad }}
                        </td>
