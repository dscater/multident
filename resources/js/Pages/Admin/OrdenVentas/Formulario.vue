...
const aplicaPromocionFila = (index,list_promocions,e) => {
    ...
    if(list_promocions.length > 0 && value){
        ...
        if(promocion){
            ...
            const subtotal = parseFloat(form.detalle_ordens[index].cantidad) * parseFloat(form.detalle_ordens[index].precio);
            form.detalle_ordens[index].subtotal = parseFloat(parseFloat(subtotal * valor_descuento).toFixed(2));
            form.detalle_ordens[index].promocion_id = value;
            form.detalle_ordens[index].promocion_descuento = parseFloat(promocion.porcentaje);
            form.detalle_ordens[index].promocion = promocion;
        }

    }else{
        form.detalle_ordens[index].subtotal = parseFloat(parseFloat(form.detalle_ordens[index].cantidad) * parseFloat(form.detalle_ordens[index].precio)).toFixed(2);
        form.detalle_ordens[index].promocion_id = 0;
        form.detalle_ordens[index].promocion_descuento = 0;
        form.detalle_ordens[index].promocion = null;
    }
    sumaTotales();
}
