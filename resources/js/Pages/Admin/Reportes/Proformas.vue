...
const generarReporte = () => {
    ...
    const url = route("reportes.r_proformas", form.value);
...
<template>
    <Head title="Reporte Proformas"></Head>
    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Reportes > Proformas</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reportes > Proformas</h1>
    <!-- END page-header -->
    <div class="row">
