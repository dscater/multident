...
-- Tiempo de generación: 14-04-2025 a las 01:56:34
...
(1, 'MULTIDENT', 'MD', 'MULTIDENT S.A.', 'logo.png', '2025-04-14 01:39:41', '2025-04-14 01:39:41');
...
CREATE TABLE `users` (
  ...
  `sucurals_todo` int NOT NULL DEFAULT '0',
...
INSERT INTO `users` (`id`, `usuario`, `nombres`, `apellidos`, `ci`, `ci_exp`, `correo`, `password`, `role_id`, `sucurals_todo`, `sucursal_id`, `foto`, `fecha_registro`, `acceso`, `status`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin', 'admin', '0', '', 'admin@admin.com', '$2y$12$65d4fgZsvBV5Lc/AxNKh4eoUdbGyaczQ4sSco20feSQANshNLuxSC', 1, 1, NULL, NULL, '2025-04-13', 1, 1, NULL, NULL);
